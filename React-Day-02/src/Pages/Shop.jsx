...
const Shop = () => {
  let productList = [
    ...
    },
    {
      ...
      price: 599,
      description:
        "21. 5 inches Full HD (1920 x 1080) widescreen IPS display And Radeon free Sync technology. No compatibility for VESA Mount Refresh Rate: 75Hz - Using HDMI port Zero-frame design.",
      category: "electronics",
    ...
    <div>
      <div className="container my-3">
        ...
        <p className="text-center fs-6">
          <b>render product cards dynamically</b> using the productsList array
          by
          <b> mapping each product</b> to a reusable ProductCard component,
          passing product <b>data via props</b>, and displaying the information
          in a clean and scalable component structure.
        </p>
      </div>
